...
const tablesSchema = __schema({
  canvasObject: __table({
    name: 'canvas_object',
    indexes: [
      { accessor: 'id', name: 'canvas_object_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'by_xy', name: 'canvas_object_x_y_idx_btree', algorithm: 'btree', columns: [
        'x',
        'y',
      ] },
    ],
    constraints: [
      { name: 'canvas_object_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, CanvasObjectRow),
  comment: __table({
    name: 'comment',
    indexes: [
      ...
      { accessor: 'objectId', name: 'comment_object_id_idx_btree', algorithm: 'btree', columns: [
        'objectId',
      ] },
    ],
    constraints: [
  ...
  objectHistory: __table({
    name: 'object_history',
    indexes: [
      { accessor: 'id', name: 'object_history_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
      { accessor: 'objectId', name: 'object_history_object_id_idx_btree', algorithm: 'btree', columns: [
        'objectId',
      ] },
    ],
    constraints: [
      { name: 'object_history_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, ObjectHistoryRow),
  reaction: __table({
    name: 'reaction',
    indexes: [
      ...
      { accessor: 'objectId', name: 'reaction_object_id_idx_btree', algorithm: 'btree', columns: [
        'objectId',
      ] },
    ],
    constraints: [
...
type __SchemaWithTableAccessorAliases = Omit<typeof tablesSchema.schemaType, "tables"> & {
  tables: typeof tablesSchema.schemaType.tables & {
    /** @deprecated Use `canvasObject` instead. This alias will be removed in the next major version. */
